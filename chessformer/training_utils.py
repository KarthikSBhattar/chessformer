...
def update_parameters(
    ...
    new_params_ema = jax.tree_map(lambda ema, param: _update_ema(ema, param), params_ema, new_params)
...
def get_checkpoint_manager(
    ...
    checkpointers = dict(
        ...
        # Removed `data_iter` as PyGrain is no longer used.
    )
...
def restore_checkpoint(
    ...
    opt_state: optax.OptState,
    sharding: jax.sharding.PositionalSharding,
) -> tuple[hk.Params, hk.Params, optax.OptState]:
